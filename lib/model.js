    ...
    return Promise.try(() => {
      ...
      for (const instance of instances) {
        ...
        if (createdAtAttr && !values[createdAtAttr]) {
          let createdAtField = instance.rawAttributes[createdAtAttr].field;
          values[createdAtField ? createdAtField : createdAtAttr] = now;
        }
        if (updatedAtAttr && !values[updatedAtAttr]) {
          let updatedAtField = instance.rawAttributes[updatedAtAttr].field;
          values[updatedAtField ? updatedAtField : updatedAtAttr] = now;
        }
